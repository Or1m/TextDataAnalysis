        ...
        public static void Main()
        {
            ...
            for (int i = 0; i < patterns.Length; i++)
            {
                ...
                while (activeStates.Count > 0)
                {
                    ...
                    if (stateNumber > numOfStates || patternIdx >= text.Length)
                        continue;
                    ...
                    var statePlusLen = stateNumber + pattern.Length;

                    if (statePlusLen + 1 <= numOfStates)
                    {
                        activeStates.Enqueue((statePlusLen + 1, patternIdx));
                        activeStates.Enqueue((statePlusLen + 1, patternIdx + 1));
                    }

                    if (statePlusLen + 2 <= numOfStates)
                    {
                        activeStates.Enqueue((statePlusLen + 2, patternIdx));
                        activeStates.Enqueue((statePlusLen + 2, patternIdx + 1));
                    } 
                }
            }
